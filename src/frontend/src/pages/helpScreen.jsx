...
function HelpScreen() {
  return (
    <div className='flex items-center bg-black flex-col align-middle h-screen'>
      <div className='overflow-y-scroll h-2/4 mt-20 scrollbar-wide scrollbar-thumb-gray-600 scrollbar-track-gray-800'>
        ...
        <div className="bg-black text-white w-full flex flex-col items-center justify-center border-2 border-white rounded p-4 mt-10 md:mt-32">
